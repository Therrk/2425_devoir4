...
/****************************************************************************/
/* CREE_XIMAGECOUL()							    */
/* Cr�e une XImage � partir d'un tableau 3 d de float                       */
/* L'image peut subir un zoom.						    */
/****************************************************************************/
...
int main (int argc, char **argv)
{
  ...
  //par une image couleur donn� par l'�quation d'en bas... et non pas par 
  ...
  //Un exemple ou la matrice de points MatPict est remplie
  //par une image en niveaux de gris  donn� par l'�quation d'en bas... et non pas par 
